...
class MyFrameQ16 extends JFrame implements ActionListener{
	...
	private JButton b2=new JButton("  Contains A Zero");private JTextField t3=new JTextField("0",15);
	private JPanel p1=new JPanel();
	ArrayList<Integer> list = new ArrayList<Integer>();

	public static boolean noZeros(ArrayList list){              // to be completed
	...
	public void actionPerformed(ActionEvent e){
 	...
 	if (target==b2){ 
  		boolean res = noZeros(new ArrayList(list));
  		t3.setText(""+res);
     	}
     }
	 }
